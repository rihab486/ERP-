...
,
  ...
  const DeleteCongé = (congeId) => {
    ...
    <div>
      ...
      {conges.length==0? <h3>Pas de conges</h3>
  :
    ...
    <tr>
     ...
     <th scope="col">Employé</th>
      ...
      <th scope="col">Date de début congé</th>
      <th scope="col">Date de fin congé</th>
  ...
  <tbody>
    ...
    {conges.filter(x=>  x.datedebut!=null).map(conge =>
          <tr key={conge.idconge}>
              <td>{conge.user_name}</td>
              <td>{conge.datedebut?"congé":"" }</td>
