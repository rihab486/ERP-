...
const RapportAnnulle = () => {
  ...
  const handleToggle = () => {
   setOpenn(!openn)
    ...
    function SelectRaAnnuelle(employes,date1,date2) {
      
      
            fetch("http://127.0.0.1:8000/RapportAnuellement/" +date1+"/"+date2+"/?id="+employes).then((result) => {
...
Importer Rapport Annuelle
</button>
                             <ReactHTMLTableToExcel
                              
                              className='btn btn-default'
                              table="annuelletoexcel"
                              filename="Rapport annuelle"
                              sheet="tablexls"
                              buttonText="Excel"
                              />
</div>
                    ...
                    <div className="modal-dialog modal-dialog-centered" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="exampleModalLabel">Importer Un Rapport Annuelle</h5>
...
<input className="form-control" placeholder="" value={date2} name="date_pointage" onChange={(e) => setDate2(e.target.value)} type="date" />
    ...
    <div className='row'>
                             ...
                             <div className="col-md-6">
                              ...
                              <FormControl className={classes.formControl}>
                                    ...
                                    <div className="form-group">
                                        <a className="btn btn-primary"  data-dismiss="modal"  onClick={()=>{SelectRaAnnuelle(employe,date1,date2);handleToggle()}}>Importer</a></div>
                                </form>
        )}/>
                            </div>
    ...
    {post? 
        ...
        <table className="table align-items-center table-flush" id="annuelletoexcel" >
          <thead className="thead-light">
            <tr>
              ...
              <th scope="col">Travail indirect</th>
              <th scope="col">Travail direct</th>
              <th scope="col">Heures pratiques</th>
